...
export declare class DataUtil {
    ...
    static group<T>(data: T[], state: IGroupingState, grid?: any, groupsRecords?: any[]): IGroupByResult;
    static restoreGroups(groupData: IGroupByResult, state: IGroupingState): any[];
    private static restoreGroupsIterative;
