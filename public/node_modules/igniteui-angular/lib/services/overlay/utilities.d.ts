 ...
 */
export declare function getTargetRect(settings: PositionSettings): ClientRect;
/** @hidden */
...
/** @hidden @internal */
export declare function getViewportRect(document: Document): ClientRect;
/** @hidden @internal */
export declare function getViewportScrollPosition(): Point;
/** @hidden @internal*/
export declare function cloneInstance(object: any): any;
